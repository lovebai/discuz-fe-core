...
interface IHintExtend {
    ...
    // value: key值，textareaPosition：文本位置
    hintCustom?(value: string, textareaPosition?: any, lastIndex?: any): any; // 自定义的提示
}
...
interface IOptions {
    ...
    /** @link https://ld246.com/article/1549638745630#options-toolbar */
    toolbar?: Array<string | IMenuItem>;
    bubbleToolbar?: Array<string | IMenuItem>;
    ...
    /** 输入后触发 */
    input?(value: string, event?: Event | InsertValueEvent | InputEvent): void; // , previewElement?: HTMLElement
