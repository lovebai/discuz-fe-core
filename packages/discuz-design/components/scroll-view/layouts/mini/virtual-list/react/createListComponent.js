...
export default function createListComponent({
  ...
  return (
    (_temp = _class = class List extends PureComponent {
      ...
      constructor(props) {
        ...
        this._getCountSize = (props, count) => {
          ...
          return sizes.reduce((p, a) => p + this._getSize(a), 0);
        };
        ...
        this._getStyleValue = (value) => (typeof value === 'number' ? `${value}px` : value == null ? '' : value);
      ...
      render() {
        ...
        const { id, isScrolling, scrollOffset, scrollUpdateWasRequested } = this.state; // TODO Deprecate direction "horizontal"
