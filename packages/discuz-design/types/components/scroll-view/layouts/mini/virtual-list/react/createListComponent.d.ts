...
export function getRectSize(id: any, success?: () => void, fail?: () => void): void;
export default function createListComponent({ getItemOffset, getEstimatedTotalSize, getItemSize, getOffsetForIndexAndAlignment, getStartIndexForOffset, getStopIndexForStartIndex, initInstanceProps, shouldResetStyleCacheOnItemSizeChange, validateProps, }: {
    getItemOffset: any;
    getEstimatedTotalSize: any;
    getItemSize: any;
    getOffsetForIndexAndAlignment: any;
    getStartIndexForOffset: any;
    getStopIndexForStartIndex: any;
    initInstanceProps: any;
    shouldResetStyleCacheOnItemSizeChange: any;
    validateProps: any;
}): {
    new (props: any): {
        _instanceProps: any;
